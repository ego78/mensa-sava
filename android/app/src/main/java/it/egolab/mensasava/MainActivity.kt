...
class MainActivity : AppCompatActivity() {
 ...
 override fun onCreate(savedInstanceState:Bundle?){super.onCreate(savedInstanceState);setContentView(R.layout.activity_main)
  ...
  fun go(b:android.view.View,u:String){b.setOnClickListener{it.animate().scaleX(.97f).scaleY(.97f).setDuration(70).withEndAction{it.animate().scaleX(1f).scaleY(1f).setDuration(120).start();showWebAuth(u)}.start()}}
